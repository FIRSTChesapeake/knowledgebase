...
1. Connect to an HDMI port on the back of the TV, or other display device.
2. Connect USB power to an input power source.
   %%TODO: can TV power be used to power the sticks? Test%%
...
1. Connect a keyboard/mouse to the stick PC. 
